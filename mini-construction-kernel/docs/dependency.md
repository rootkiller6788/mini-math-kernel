# mini-construction-kernel -- Dependency Graph
...
Constructions/Products.lean   → Core/Basic, Constructions/Universal
...
- `mini-object-kernel` -- provides the `Object` typeclass, `TheoryName`, and core infrastructure
